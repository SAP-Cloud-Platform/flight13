@AbapCatalog.sqlViewName: '/DMO/CURRHLP13'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'Help View for Currency Conversion'
define view /DMO/CURRENCY_HELPER13
  with parameters
    amount             : /dmo/total_price13,
    source_currency    : /dmo/currency_code13,
    target_currency    : /dmo/currency_code13,
    exchange_rate_date : /dmo/booking_date13

  as select from /dmo/agency13

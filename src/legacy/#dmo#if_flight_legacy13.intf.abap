...
INTERFACE /dmo/if_flight_legacy13
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL13
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel13     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING13
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking13    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_13
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_13 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT13
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight13 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id13.
  ...
  TYPES booking_id TYPE /dmo/booking_id13.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id13.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL13, /DMO/BOOKING13, /DMO/BOOK_SUP_13 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code13.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code13,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status13,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel13_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id13.
  INCLUDE TYPE /dmo/booking13_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id13.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id13.
  INCLUDE TYPE /dmo/book_sup_13_data.

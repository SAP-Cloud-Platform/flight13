CLASS /dmo/cx_flight_legacy13 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_13',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_13',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id13 OPTIONAL
        booking_id            TYPE /dmo/booking_id13 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id13 OPTIONAL
        agency_id             TYPE /dmo/agency_id13 OPTIONAL
        customer_id           TYPE /dmo/customer_id13 OPTIONAL
        carrier_id            TYPE /dmo/carrier13-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_13-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_13-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date13 OPTIONAL
        end_date              TYPE /dmo/end_date13 OPTIONAL
        booking_date          TYPE /dmo/booking_date13 OPTIONAL
        flight_date           TYPE /dmo/flight_date13 OPTIONAL
        status                TYPE /dmo/travel_status13 OPTIONAL
        currency_code         TYPE /dmo/currency_code13 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id13,
          mv_booking_id            TYPE /dmo/booking_id13,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id13,
          mv_agency_id             TYPE /dmo/agency_id13,
          mv_customer_id           TYPE /dmo/customer_id13,
          mv_carrier_id            TYPE /dmo/carrier13-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_13-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_13-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date13,
          mv_end_date              TYPE /dmo/end_date13,
          mv_booking_date          TYPE /dmo/booking_date13,
          mv_flight_date           TYPE /dmo/flight_date13,
          mv_status                TYPE /dmo/travel_status13,
          mv_currency_code         TYPE /dmo/currency_code13,
...
CLASS /dmo/cx_flight_legacy13 IMPLEMENTATION.

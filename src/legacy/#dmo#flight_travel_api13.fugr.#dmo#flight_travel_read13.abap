...
"! @parameter es_travel             | Travel Data like /DMO/TRAVEL13 related to the importing Travel ID
"! @parameter et_booking            | Table of Bookings like /DMO/BOOKING13 related to the importing Travel ID
"! @parameter et_booking_supplement | Table of Booking Supplements like /DMO/BOOK_SUP_13 related to the importing Travel ID
"! @parameter et_messages           | Table of occurred messages
"!
FUNCTION /DMO/FLIGHT_TRAVEL_READ13.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
*"----------------------------------------------------------------------
  ...
  /dmo/cl_flight_legacy13=>get_instance( )->get_travel( EXPORTING iv_travel_id          = iv_travel_id
